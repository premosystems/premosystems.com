...
; (function ($) {
    ...
    h.defaults = {
        axis: 'xy',
        duration: parseFloat($.fn.jquery) >= 1.3 ? 0 : 1, limit: true
    };
    h.window = function (a) {
        ...
        return this._scrollable().each(function () {
            ...
            $.each(g.axis.split(''), function (i, a) {
                ...
                if (toff) {
                    ...
                    if (g.margin) { attr[key] -= parseInt(targ.css('margin' + b)) || 0; attr[key] -= parseInt(targ.css('border' + b + 'Width')) || 0 } attr[key] += g.offset[pos] || 0; if (g.over[pos]) attr[key] += targ[a == 'x' ? 'width' : 'height']() * g.over[pos]
                }
                else {
